...
NG: まとめ後に「商品を選んだあとは○○」「また、どの商品を選んだとしても」
    のような追記パラグラフを連ねる

OK: 共通注意点は「選定基準」または「選び方」セクションで1回だけ書く
OK: 各商品は「ここでしか言えない独自の特徴」を1〜2個明示
OK: まとめは要点整理＋自然な CTA で1セクション内で完結

【ランキング記事の密度勾配（ranking タイプのとき）】
全件を均等な分量で書くと冗長になる。順位に応じて情報密度に勾配をつける:
- 1位       : 厚く（400〜500字、特徴2段落＋注意点＋向いている人 ul）
- 2-3位     : やや厚く（300〜400字）
- 4位以降   : 簡潔に（150〜250字、ul は省略可）
- 最下位2件 : 最も簡潔に（100〜200字）
