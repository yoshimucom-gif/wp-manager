...
SPECS = [
    (os.path.join(ROOT, 'affiros-product-inserter'),
     'affiros-product-inserter', 'affiros-product-inserter-1.10.1.zip'),
    (os.path.join(ROOT, 'affiros-decoration'),
     'affiros-decoration', 'affiros-decoration-1.2.4.zip'),
    (os.path.join(ROOT, 'affiros-rewrite'),
     'affiros-rewrite', 'affiros-rewrite-0.5.18.zip'),
    (os.path.join(ROOT, 'affiros-categorizer'),
     'affiros-categorizer', 'affiros-categorizer-0.1.2.zip'),
    (os.path.join(ROOT, 'affiros-dup-cleaner'),
     'affiros-dup-cleaner', 'affiros-dup-cleaner-1.0.2.zip'),
    (os.path.join(ROOT, 'affiros-paragraph-splitter'),
     'affiros-paragraph-splitter', 'affiros-paragraph-splitter-1.1.6.zip'),
    (os.path.join(ROOT, 'affiros-reschedule'),
     'affiros-reschedule', 'affiros-reschedule-1.1.1.zip'),
    (os.path.join(ROOT, 'affiros-mark-stripper'),
     'affiros-mark-stripper', 'affiros-mark-stripper-1.0.1.zip'),
    (os.path.join(ROOT, 'affiros-auto-inserter'),
     'affiros-auto-inserter', 'affiros-auto-inserter-0.17.4.zip'),
    (os.path.join(ROOT, 'affiros-cat-eyecatch'),
     'affiros-cat-eyecatch', 'affiros-cat-eyecatch-1.0.1.zip'),
