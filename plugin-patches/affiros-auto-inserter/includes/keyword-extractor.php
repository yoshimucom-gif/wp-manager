...
class Affiros_AI_Keyword_Extractor {
    ...
    public function filter_relevant($keyword, $article_title, $products) {
        ...
        $prompt = "記事の商品カードに載せる商品の検品をしてください。\n\n"
            ...
            . "- 判定の主軸は**タイトルの日本語品質**:\n"
            . "  ・自然な日本語タイトル → 合格\n"
            . "  ・機械翻訳調・不自然な日本語タイトル → 補欠\n"
            . "    (例: 「陽気な偽スパイダーペン小道具、家族の集まり、誕生日パーティー、社交イベント用」)\n"
            . "- **ブランド名がランダム英字なだけでは補欠にしない**\n"
            . "  (Amazonにはランダム英字ブランドでも高評価で売れている実力商品が多い。\n"
            . "   例: [WINROMTICO] 高コスパ スーツ メンズ 3点セット → タイトルが自然なので合格)\n"
            . "  ランダム英字ブランドは、タイトルも不自然な場合の補強シグナルとしてのみ使う\n"
            . "- シーン語の列挙 (就活 結婚式 礼服 など) は検索対策の常套で正常。\n"
            . "  日本語として破綻したカンマ羅列だけを補欠にする\n\n"
            . "## 共通ルール\n"
